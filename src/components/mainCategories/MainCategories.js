          ...
          <div className="col-md-10 ">
            ...
            <div className="row">
              <div className="col-md-10 offset-md-1 content" >
                {mainCategories.loading ? (<em>Ładowanie kategorii <img alt="loading" src="data:image/gif;base64," />
                </em>) : (
